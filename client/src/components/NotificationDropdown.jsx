            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 mt-3 w-80 sm:w-96 bg-background/95 dark:bg-background/95 backdrop-blur-3xl border border-border/60 rounded-3xl shadow-[0_10px_50px_rgba(0,0,0,0.5)] z-50 overflow-hidden"
                    >
                        {/* Header */}
