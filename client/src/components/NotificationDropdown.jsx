            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="fixed inset-x-3 top-[70px] sm:absolute sm:right-0 sm:top-full sm:inset-x-auto mt-3 w-auto sm:w-96 max-w-[400px] bg-background/95 dark:bg-background/95 backdrop-blur-3xl border border-border/60 rounded-2xl sm:rounded-3xl shadow-[0_10px_50px_rgba(0,0,0,0.5)] z-50 overflow-hidden"
                    >
                        {/* Header */}
