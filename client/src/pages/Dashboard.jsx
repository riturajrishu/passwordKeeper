...
const AutoLockTimerDisplay = () => {
    ...
    return (
        <div className={clsx(
            ...
            <span className="hidden xs:inline uppercase tracking-tighter">Auto-Lock:</span>
    ...
    return (
        <div className="p-4 lg:p-8 pb-16">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
                <div>
                    <h1 className="text-3xl sm:text-4xl font-black tracking-tight text-foreground mb-1">Vault Overview</h1>
                    <p className="text-muted-foreground text-sm font-medium">
                        {stats.total} item{stats.total !== 1 ? 's' : ''} encrypted with AES-256 · Press <kbd className="px-2 py-1 rounded-lg bg-muted border border-border text-[10px] font-mono shadow-sm">Ctrl+N</kbd>
                    </p>
                </div>
                <div className="flex flex-wrap items-center gap-3">
                    <AutoLockTimerDisplay />
                    <div className="relative flex-1 sm:flex-initial min-w-[180px] sm:w-64 group">
                    ...
                    <motion.button
                        ...
                        className="bg-primary text-primary-foreground px-6 py-3 rounded-xl font-black text-sm shadow-xl shadow-primary/25 flex items-center gap-2 shrink-0 transition-all hover:shadow-primary/40"
                    >
                    ...
                    {[
                        ...
                        <button
                            ...
                            className={clsx(
                                ...
                                activeTab === tab.id
                                    ? tab.id === 'favorites' ? 'bg-card shadow-premium text-yellow-500' : 'bg-card shadow-premium text-primary'
